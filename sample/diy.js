(function () {
    ...
    html += '<a href="" class="diy export" data-type="json">导出json</a>',
        ...
        html += '<a href="" class="diy export" data-type="xmind">导出Xmind</a>',
        html += '<button class="diy input">',
        html += '导入<input type="file" id="fileInput" accept=".km,.txt,.md,.json,.xmind" >',
        html += '</button>';
    ...
    window.onload = function () {
        ...
        fileInput.addEventListener('change', function (e) {
            ...
            reader.onload = function (e) {
                ...
                editor.minder.importData(fileType, fileInput.files[0]).then(function (data) {
                    $(fileInput).val('');
                });
            }
